...
resp = requests.get(
    f"{BASE_URL}/logs/",
    params={'from_date': '2026-06-07T06:00:00', 'to_date': '2026-06-08T05:59:59', 'limit': 200},
...
class PDF(FPDF):
    def header(self):
        ...
        self.set_xy(10, 4)
        self.cell(0, 10, 'SPECTRUM VIVIENDA  |  Reporte Leads Fase 2  |  7 Junio 2026', align='L')
...
pdf.cell(0, 5, '7 de Junio 2026  (hora Guatemala, UTC-6)', ln=True)
pdf.ln(4)
...
out = 'postman/reportes fase 2/leads_fase2_07junio.pdf'
pdf.output(out)
