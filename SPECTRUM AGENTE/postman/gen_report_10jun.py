#!/usr/bin/env python3
"""Reporte Leads Fase 2 — 10 de junio 2026 (MongoDB: users_fase_2 x users)"""
import sys
...
# Junio 10 GT 00:00–23:59 = Jun 10 06:00 UTC → Jun 11 05:59 UTC
FROM_UTC = datetime(2026, 6, 10, 6, 0, 0, tzinfo=timezone.utc)
TO_UTC   = datetime(2026, 6, 11, 5, 59, 59, tzinfo=timezone.utc)
...
def last_int_str(s):
    # s = "2026-06-10T07:37:50.243-06:00" — tiempo ya en GT (offset -06:00)
...
lines = [
    "REPORTE LEADS FASE 2 — 10 DE JUNIO 2026",
...
out_file = "postman/reportes fase 2/leads_fase2_10junio.txt"
