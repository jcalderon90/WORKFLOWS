...
class PDF(FPDF):
    def header(self):
        ...
        self.set_xy(10, 4)
        self.cell(0, 10, 'SPECTRUM VIVIENDA  |  Reporte Leads Fase 2  |  2 Junio 2026', align='L')
...
pdf.cell(0, 5, '2 de Junio 2026  (hora Guatemala, UTC-6)', ln=True)
pdf.ln(4)
...
out = 'postman/reportes fase 2/leads_fase2_02junio.pdf'
pdf.output(out)
