...
resp = requests.get(
    f"{BASE_URL}/logs/",
    params={'from_date': '2026-06-03T06:00:00', 'to_date': '2026-06-04T05:59:59', 'limit': 200},
...
class PDF(FPDF):
    def header(self):
        ...
        self.set_xy(10, 4)
        self.cell(0, 10, 'SPECTRUM VIVIENDA  |  Reporte Leads Fase 2  |  3 Junio 2026', align='L')
...
pdf.cell(0, 5, '3 de Junio 2026  (hora Guatemala, UTC-6)', ln=True)
pdf.ln(4)
...
out = 'postman/reportes fase 2/leads_fase2_03junio.pdf'
pdf.output(out)
