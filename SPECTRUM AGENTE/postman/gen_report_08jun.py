...
resp = requests.get(
    f"{BASE_URL}/logs/",
    params={'from_date': '2026-06-08T06:00:00', 'to_date': '2026-06-09T05:59:59', 'limit': 200},
...
print('# Reporte Leads Fase 2 — 8 de Junio 2026\n')
...
output_file = 'postman/reportes fase 2/leads_fase2_08junio.csv'
