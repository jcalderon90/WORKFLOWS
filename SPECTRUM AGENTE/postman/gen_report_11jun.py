#!/usr/bin/env python3
"""Reporte Leads Fase 2 — 11 de junio 2026 (MongoDB: users_fase_2 x users)"""
import sys
...
# Junio 11 GT 00:00–23:59 = Jun 11 06:00 UTC → Jun 12 05:59 UTC
FROM_UTC = datetime(2026, 6, 11, 6, 0, 0, tzinfo=timezone.utc)
TO_UTC   = datetime(2026, 6, 12, 5, 59, 59, tzinfo=timezone.utc)
...
lines = [
    "REPORTE LEADS FASE 2 — 11 DE JUNIO 2026",
...
out_file = "postman/reportes fase 2/leads_fase2_11junio.txt"
